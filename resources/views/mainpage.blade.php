...
@section('content')
  ...
  <!-- ======= Hero Section ======= -->
  <div id="hero" class="hero route bg-image" style="background-image: url(assets/img/AJI_0933.jpg)">
                ...
                <div class="col-md-6">
                  <div class="row">
                    <div class="col-sm-6 col-md-5">
                      <div class="about-img">
                        <img src="assets/img/20210312_171451.jpg" class="img-fluid rounded b-shadow-a" alt="">
                      </div>
                    </div>
